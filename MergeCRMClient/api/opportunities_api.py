...
class OpportunitiesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.opportunities_create = _Endpoint(
            settings={
                'response_type': (OpportunityResponse,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/opportunities',
            ...
            callable=__opportunities_create
        )

        def __opportunities_list(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.opportunities_list = _Endpoint(
            settings={
                'response_type': (PaginatedOpportunityList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/opportunities',
            ...
            api_client=api_client,
            callable=__opportunities_list
        )

        def __opportunities_meta_post_retrieve(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.opportunities_meta_post_retrieve = _Endpoint(
            settings={
                'response_type': (MetaResponse,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/opportunities/meta/post',
            ...
            api_client=api_client,
            callable=__opportunities_meta_post_retrieve
        )

        def __opportunities_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.opportunities_retrieve = _Endpoint(
            settings={
                'response_type': (Opportunity,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/opportunities/{id}',
            ...
            api_client=api_client,
            callable=__opportunities_retrieve
        )
